...
local Buffer = game:GetService("HttpService"):GetAsync('https://4805-41-109-150-155.ngrok-free.app/v1/get_image') -- inside the getasync you should have your ngrok's link (eg: GetAsync('https://4805-41-109-150-155.ngrok-free.app/v1/get_image')
